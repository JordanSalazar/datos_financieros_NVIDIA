...
fig.add_trace(go.Scatter(x=df.index, y=df['Close'], mode='lines', line=dict(color='#050202'))) # color del logo de nvidia

# establecer el diseño del grafico
fig.update_layout(title='Precio de las acciones de APLE',
